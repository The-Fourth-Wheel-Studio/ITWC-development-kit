...
class color():
    ...
    index = {"RED" : RED, "BLACK" : BLACK, "GREEN" : GREEN, "YELLOW" : YELLOW, "BLUE" : BLUE, "MAGENTA" : MAGENTA, "CYAN" : CYAN, "WHITE" : WHITE, "BRIGHT_RED" : BRIGHT_RED, "BRIGHT_BLACK" : BRIGHT_BLACK, "BRIGHT_GREEN" : BRIGHT_GREEN, "BRIGHT_YELLOW" : BRIGHT_YELLOW, "BRIGHT_BLUE" : BRIGHT_BLUE, "BRIGHT_MAGENTA" : BRIGHT_MAGENTA, "BRIGHT_CYAN" : BRIGHT_CYAN, "BRIGHT_WHITE" : BRIGHT_WHITE, "BOLD" : BOLD,"DEFAULT" : DEFAULT, "RESET" : RESET}
...
def MKinput(printStr : str, instrName : str = "default", colorID : "color" = "DEFAULT") -> str:
    return input(coloredStr("[" + getHourStr() + " - "+ instrName + "] ", colorID)  + printStr)
